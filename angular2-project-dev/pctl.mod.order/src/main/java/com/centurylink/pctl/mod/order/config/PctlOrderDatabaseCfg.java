 ...
 */
@Configuration
@EnableMongoRepositories("com.centurylink.pctl.mod.order")
@Import(value = MongoAutoConfiguration.class)
//@EnableMongoAuditing(auditorAwareRef = "springSecurityAuditorAware")
public class PctlOrderDatabaseCfg extends AbstractDatabaseConfiguration {

    private final Logger log = LoggerFactory.getLogger(PctlOrderDatabaseCfg.class);
