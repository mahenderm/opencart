...
declare var BASE_URL_USERS_INIT: string;
declare var BASE_URL_USERS_INFO: string;
declare var BASE_URL_USERS_CART: string;
declare var BASE_URL_CART_EVENTS: string; // Cart Events
declare var BASE_URL_CART_BASIC: string; // Get Shopping Cart
declare var BASE_URL_ORDER_CHECKOUT: string; // check out
declare var BASE_URL_ORDER_SUMMARY: string; // order summary
declare var BASE_URL_PRICES: string;
declare var BASE_URL_ADD_VAL: string;
declare var BASE_URL_ORDER_SUBMIT: string; // order submit
declare var BASE_URL_CONTACTUS: string; // Contact Us Page
declare var BASE_URL_UI_INIT_SESSION: string; // init session in UI Page
declare var BASE_URL_TNC: string;
