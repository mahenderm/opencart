...
public class ObjectFactory {
    ...
    private final static QName _ServiceDataAccessException_QNAME = new QName("http://ecaps.ctl.com/exceptions", "ServiceDataAccessException");
    private final static QName _ServiceSystemException_QNAME = new QName("http://ecaps.ctl.com/exceptions", "ServiceSystemException");
    private final static QName _ServiceRemoteCallException_QNAME = new QName("http://ecaps.ctl.com/exceptions", "ServiceRemoteCallException");
     ...
     *
     */
    @XmlElementDecl(namespace = "http://ecaps.ctl.com/exceptions", name = "ServiceDataAccessException")
    public JAXBElement<FaultDetailSO> createServiceDataAccessException(FaultDetailSO value) {
        return new JAXBElement<FaultDetailSO>(_ServiceDataAccessException_QNAME, FaultDetailSO.class, null, value);
    }
     ...
     *
     */
    @XmlElementDecl(namespace = "http://ecaps.ctl.com/exceptions", name = "ServiceRemoteCallException")
    public JAXBElement<FaultDetailSO> createServiceRemoteCallException(FaultDetailSO value) {
        return new JAXBElement<FaultDetailSO>(_ServiceRemoteCallException_QNAME, FaultDetailSO.class, null, value);
    }
