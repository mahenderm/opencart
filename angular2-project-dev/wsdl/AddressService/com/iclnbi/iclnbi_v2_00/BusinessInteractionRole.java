...
public class BusinessInteractionRole {
    ...
    @XmlElementRef(name = "interactionRole", namespace = "http://www.ICLNBI.com/ICLNBI_V2.00.xsd", type = JAXBElement.class, required = false)
    protected JAXBElement<String> interactionRole;
     ...
     *
     */
    public JAXBElement<String> getInteractionRole() {
     ...
     *
     */
    public void setInteractionRole(JAXBElement<String> value) {
