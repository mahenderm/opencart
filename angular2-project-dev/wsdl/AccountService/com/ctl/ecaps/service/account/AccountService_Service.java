 ...
 * 
 */
@WebServiceClient(name = "AccountService", targetNamespace = "http://ecaps.ctl.com/service/account", wsdlLocation = "file:/C:/1PCenturyLink/WSDLs/Real-WSDLs/AccountService.xml")
    ...
    extends Service
{
    ...
    private final static QName ACCOUNTSERVICE_QNAME = new QName("http://ecaps.ctl.com/service/account", "AccountService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("file:/C:/1PCenturyLink/WSDLs/Real-WSDLs/AccountService.xml");
    ...
    public AccountService getAccountServicePort() {
        return super.getPort(new QName("http://ecaps.ctl.com/service/account", "AccountServicePort"), AccountService.class);
    }
    ...
    public AccountService getAccountServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ecaps.ctl.com/service/account", "AccountServicePort"), AccountService.class, features);
    }
